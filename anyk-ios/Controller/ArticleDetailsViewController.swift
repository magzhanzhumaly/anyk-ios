...
//        scrollView.addSubview(titleImage)
    ...
    override func viewDidLayoutSubviews() {// 26
        ...
        authorNameText.frame = CGRect(x: Int(authorPhoto.frame.maxX) + 10, y: Int(authorPhoto.frame.origin.y), width: Int(authorNameText.intrinsicContentSize.width) + 10, height: Int(authorPhoto.frame.height) / 2)
